package com.example.sunapp.ui.adapter
...
class ProfileDataAdapter2(private val chaptersList: List<Heroins>) :
    RecyclerView.Adapter<ProfileDataAdapter2.ViewHolder>() {
